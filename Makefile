...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/01/06 15:11:20 by bchabira          #+#    #+#              #
#    Updated: 2016/01/15 05:27:48 by bchabira         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_itoa.c \
	  ...
	  ft_putchar.c ft_putchar_fd.c ft_putendl.c ft_putendl_fd.c ft_putnbr.c ft_putnbr_fd.c ft_strcat.c \
	  ...
	  ft_strtrim.c ft_tolower.c ft_toupper.c ft_putstr.c ft_putstr_fd.c ft_isspace.c ft_isblank.c ft_lstnew.c \
	  ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_count_word.c \
